      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          ...
          <div>
            <img
            data-aos="zoom-in"
            className="max-w-[400px] block mx-auto h-[350px] w-full drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover " src={Library} alt="" />
          </div>
          {/* {text content section} */}
          <div
          data-aos="slide-up"
          className="flex flex-col justify-center gap-6 sm:pt-0 px-14 sm:px-0">
            <h1 className="text-3xl sm:text-4xl font-bold">
              Library at your fingertips
            </h1>
            <p className="text-sm text-gray-600 leading-5 tracking-wide dark:text-gray-400 ">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero
              neque voluptatem unde in atque at, beatae incidunt provident.
              Consectetur, quo.
            </p>
